 ...
 * to the trading amount.
 * i.e. (ra) = (profit) x (rr), where ra = re-invest amount,
 ...
 * After the result of this function get true, the bot starts
 * watching the market.
 *
 * Note that this function doesn't place the position actually.
 * After this function returns true, and the entryPoint gets true, the position
 ...
 * After the result of this function get true, the bot starts watching
 * the market to exit the position.
 *
 * Note that this function doesn't exit the position actually. After this
 * function returns true, and the exitPoint gets true, the position will be
 * actually exited.
 * @param {PriceVolume} current - Current Price
 * @returns {boolean} - Return true when the market has reached watchpoint, and
 *  return false otherwise.
